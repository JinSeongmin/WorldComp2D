...
from Utils import load_auxiliary_localizer
...
def framework_making(task) : 
    ...
    aux_loc_1, aux_loc_2, aux_loc_3, = load_auxiliary_localizer(task, aux_loc_1, aux_loc_2, aux_loc_3)
    aux_localizers = [aux_loc_1, aux_loc_2, aux_loc_3]
    
    landmark_coordinate_prior = load_landmark_coordinate_prior(task)
    
    return encoders, localizers, aux_localizers, n_l, landmark_coordinate_prior
