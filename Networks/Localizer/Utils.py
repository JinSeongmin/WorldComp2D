...
def save_model(task, loc_1, loc_2, loc_3, loss_hist, optimizer, epoch):
    state = {
        'loc_1' : loc_1.state_dict(),
        'loc_2' : loc_2.state_dict(),
        'loc_3' : loc_3.state_dict(),
        'opt': optimizer.state_dict(),
        'loss_hist' : loss_hist,
        'epoch': epoch}
    path = "../../Checkpoint/"
    
    torch.save(state, path+'{}_Localizers_{}epoch.pth'.format(task, epoch))
